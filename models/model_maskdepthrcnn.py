...
class MaskDepthRCNN(nn.Module):
    ...
    def train_epoch(self, datagenerator, optimizer, steps, depth_weight=1, normal_weight=0.001, global_depth_weight=1):
        batch_count = 0
        loss_sum = 0
